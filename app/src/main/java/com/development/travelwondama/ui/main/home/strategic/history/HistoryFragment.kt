package com.development.travelwondama.ui.main.home.strategic.history
...
import com.development.travelwondama.databinding.FragmentHistoryBinding
...
class HistoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tourismArgs = KspData.dummyKsp[0].tourismHistory
