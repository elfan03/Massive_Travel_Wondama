...
import com.development.travelwondama.databinding.FragmentDetailReligiousTourismBinding
...
class DetailReligiousTourismFragment : Fragment() {

    private var _binding: FragmentDetailReligiousTourismBinding? = null
    private val binding get() = _binding
    private val navArgs: DetailReligiousTourismFragmentArgs by navArgs()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentDetailReligiousTourismBinding.inflate(layoutInflater, container, false)
        return binding?.root
    }
